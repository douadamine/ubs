...
<body>
    <div class="title">
        <span>Consultation Resultat d'examen Simple </span>
    </div>
    ...
    <div class="main">
        <div class="login ">
            <form action="" method="post" name="login">
                <fieldset>
                    <legend class="heading">Admin Connexion</legend>
        ...
        <div class="search">
            <form action="./student.php" method="get">
                <fieldset>
                    <legend class="heading">Section Etudiants</legend>
